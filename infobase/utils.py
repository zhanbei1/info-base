...
import io
from typing import List, Union, Callable, Dict, Optional, Tuple, Generator, Literal
import chardet

from infobase.configs import EMBEDDING_MODEL, EMBEDDING_DEVICE, EMBEDDING_MODEL_DICT
...
def load_embeddings(model: str = EMBEDDING_MODEL, device: str = embedding_device()) -> HuggingFaceEmbeddings:
    """
    创建一个hugging face 大模型
    """
    return HuggingFaceEmbeddings(model_name=EMBEDDING_MODEL_DICT.get(model), model_kwargs={'device': device})
